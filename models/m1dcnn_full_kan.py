...
class M1DCNN_FULL_KAN_Net(nn.Module):
    @staticmethod
    def weight_init(m):
    ...
    def __init__(self,
                 ...
                 kernel_size=None,
                 pool_size=None):
        super(M1DCNN_FULL_KAN_Net, self).__init__()
        ...
        self.conv_1 = FastKANConv1DLayer(1, 20, kernel_size, base_activation=torch.nn.PReLU, grid_size=2)
        self.conv_2 = FastKANConv1DLayer(20, 20, kernel_size, base_activation=torch.nn.PReLU, grid_size=2)
...
class M1DCNN_KAN(Model):
    def __init__(self,
        ...
        self.model = M1DCNN_FULL_KAN_Net(n_bands, n_classes)
