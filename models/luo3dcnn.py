...
# ------------------------------------------------------------------------------------------------------------------
    ...
    def __init__(self,
                 ...
                 patch_size=3,
                 n_planes=90):
        super(Luo3DCNN_Net, self).__init__()
...
class Luo3DCNN(Model):
    def __init__(self,
        ...
        self.model = Luo3DCNN_Net(n_bands, n_classes, patch_size=self.hyperparams["patch_size"])
