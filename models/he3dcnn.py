...
class He3DCNN_Net(nn.Module):
    ...
    def __init__(self, input_channels, n_classes, patch_size=7):
        super(He3DCNN_Net, self).__init__()
...
class He3DCNN(Model):
    def __init__(self,
        ...
        self.model = He3DCNN_Net(n_bands, n_classes, patch_size=self.hyperparams["patch_size"])
