...
from models.kan_layers import KAN, FastKANConv2DLayer
...
class M2DCNN_Net(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_1 = FastKANConv2DLayer(input_channels, C1, (3, 3), base_activation=nn.PReLU, grid_size=2)
        self.conv_2 = FastKANConv2DLayer(C1, 3 * C1, (3, 3), base_activation=nn.PReLU, grid_size=2)
